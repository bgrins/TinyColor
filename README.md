...
Returns the perceived brightness of a color, from `0-255`, as defined by [Web Content Accessibility Guidelines (Version 1.0)](www.w3.org/TR/AERT#color-contrast).
...
Returns the perceived luminance of a color, from `0-1` as defined by [Web Content Accessibility Guidelines (Version 2.0).](www.w3.org/TR/2008/REC-WCAG20-20081211/#contrast-ratiodef)
...
### Readability
TinyColor assesses readability based on the [Web Content Accessibility Guidelines (Version 2.0)](www.w3.org/TR/2008/REC-WCAG20-20081211/#contrast-ratiodef).
...
e on a current color.  Accepted range is in between `0-1`.
...
`isReadable: function(TinyColor, TinyColor, Object) -> Boolean`.  Ensure that foreground and background color
combinations meet WCAG guidelines. `Object` is optional, defaulting to  `{level:"AA",size:"small"}`.
